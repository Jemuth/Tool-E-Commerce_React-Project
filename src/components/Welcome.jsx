  ...
  return (
    ...
    <div className= "container_welcome">
      <div className="container">
        ...
        <NavLink to='/catalogo'><button className="card_button btn mr-2"><span id="welcometext" style={{ fontWeight: 'bold'}}>Ir al catálogo <i class="bi bi-box-arrow-in-right"></i></span></button></NavLink>
        </div>
      </div>
